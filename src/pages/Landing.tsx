        ...
        <section className="w-full h-screen bg-gradient-to-r from-joyxora-darks to-joyxora-darker text-joyxora-textMuted flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-5 py-5">
                <div className="flex flex-col items-center">
                    <h1 className="text-joyxora-green font-bold text-3xl md:text-4xl mb-4 text-center">
                        Welcome to Joyxora
                    </h1>
                    <img src={Mascot} alt="mascot" className="w-24 h-24 md:w-32 md:h-32 mb-4" />
                    <p className="text-joyxora-green text-lg md:text-xl text-center">
                    ...
                    <h2 className="text-joyxora-green text-lg md:text-xl text-center mb-4">
                            ...
                            {features.map((feature, index) => (
                                <SwiperSlide key={index}>
                                    <div className="text-center py-8 lg:py-12 px-4">
                                        {/* Feature Icon */}
                                        <div className="text-6xl md:text-7xl lg:text-8xl mb-6 lg:mb-8">
                                            {feature.icon}
                                        </div>

                                        {/* Feature Title */}
                                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-joyxora-green">
                                            {feature.title}
                                        </h2>

                                        {/* Feature Description */}
                                        <p className="text-joyxora-green text-base md:text-lg leading-relaxed">
                                            {feature.description}
                                        </p>
                                    </div>
                                </SwiperSlide>
